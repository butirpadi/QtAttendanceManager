...
class Ui_FormUtama(object):
    def setupUi(self, FormUtama):
        if not FormUtama.objectName():
            FormUtama.setObjectName(u"FormUtama")
        FormUtama.resize(643, 574)
        FormUtama.setStyleSheet(u"QPushButton {\n"
"padding:10px;\n"
"height:10px;\n"
"min-width:50px;\n"
"}")
        self.centralwidget = QWidget(FormUtama)
        ...
        FormUtama.setCentralWidget(self.centralwidget)
        ...
        self.retranslateUi(FormUtama)
        self.btnClose.clicked.connect(FormUtama.closeWindow)
        self.btnSave.clicked.connect(FormUtama.updateSetting)
        self.btnTest.clicked.connect(FormUtama.testConnection)
        self.machineTable.itemSelectionChanged.connect(FormUtama.machineSelected)
        self.btnEdit.clicked.connect(FormUtama.editMachine)
        self.btnNew.clicked.connect(FormUtama.newMachine)
        self.btnDelete.clicked.connect(FormUtama.deleteMachine)
        self.btnSync.clicked.connect(FormUtama.syncAttendance)
        self.btnMachineSave.clicked.connect(FormUtama.saveMachine)
        self.btnMachineCancel.clicked.connect(FormUtama.cancelMachine)
        self.btnTestMachine.clicked.connect(FormUtama.testMachineConnection)
        self.btnTestSync.clicked.connect(FormUtama.testAttendance)
        self.btnRawSync.clicked.connect(FormUtama.syncRawAttendance)
    ...
    def retranslateUi(self, FormUtama):
        FormUtama.setWindowTitle(QCoreApplication.translate("FormUtama", u"Odoo Attendance Manager", None))
        self.gbMachineSetting.setTitle(QCoreApplication.translate("FormUtama", u"Machine Setting", None))
        self.label_6.setText(QCoreApplication.translate("FormUtama", u"Address", None))
        self.label_5.setText(QCoreApplication.translate("FormUtama", u"Name", None))
        self.label_7.setText(QCoreApplication.translate("FormUtama", u"Port", None))
        self.btnMachineSave.setText(QCoreApplication.translate("FormUtama", u"SAVE", None))
        self.btnMachineCancel.setText(QCoreApplication.translate("FormUtama", u"CANCEL", None))
        self.btnTestMachine.setText(QCoreApplication.translate("FormUtama", u"TEST CONNECTION", None))
        self.btnTestSync.setText(QCoreApplication.translate("FormUtama", u"TEST ATTENDANCE", None))
        self.btnRawSync.setText(QCoreApplication.translate("FormUtama", u"RAW SYNC", None))
        self.btnSync.setText(QCoreApplication.translate("FormUtama", u"SYNC", None))
        self.btnNew.setText(QCoreApplication.translate("FormUtama", u"NEW", None))
        self.btnEdit.setText(QCoreApplication.translate("FormUtama", u"EDIT", None))
        self.btnDelete.setText(QCoreApplication.translate("FormUtama", u"DELETE", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabMachine), QCoreApplication.translate("FormUtama", u"Machine", None))
        self.label_2.setText(QCoreApplication.translate("FormUtama", u"Username", None))
        self.tbPassword.setInputMask("")
        self.label.setText(QCoreApplication.translate("FormUtama", u"Server Address", None))
        self.label_4.setText(QCoreApplication.translate("FormUtama", u"Database", None))
        self.label_3.setText(QCoreApplication.translate("FormUtama", u"Password", None))
        self.btnTest.setText(QCoreApplication.translate("FormUtama", u"TEST", None))
        self.btnSave.setText(QCoreApplication.translate("FormUtama", u"SAVE", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSetting), QCoreApplication.translate("FormUtama", u"Setting", None))
        self.btnClose.setText(QCoreApplication.translate("FormUtama", u"CLOSE", None))
    # retranslateUi
